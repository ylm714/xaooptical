...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  MM_columnsStr = "编号|none,none,NULL|用户姓名|',none,''|用户密码|',none,''|用户单位|',none,''|用户联系方式|',none,''|用户邮箱|',none,''"
